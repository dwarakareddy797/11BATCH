...
# a=a-b #a=12-5=7
# print(a, b)
# a, b=b, a # only in python # print(a, b)
# a=a*b #a=35
# b=a/b #b=35/7 = 5.0
# a=a/b #a=35/5= 7.0
# print(int(a), int(b))
...
# To check if the string is keyword or not # print(keyword.iskeyword("sid")) # False
# if = 8
# print(if) # error coz if is a keyword
#!----> literals
# Literal is the constant value asssigned to a variable # A variable is considers to be constant when it is defines # in caps
a= 78 # a is variable
A=78 # A is constant
# hash() --> it creates a hast value for constant datatypes and
